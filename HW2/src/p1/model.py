...
from utils import ddpm_schedules  # Import from utils.py
import numpy as np
...
class DDPM(nn.Module):
    ...
    def sample(self, n_sample, size, device, guide_w=0.0):
        ...
        format_str = "Sampling timestep {:4d} ({:5.1f}%)"

        for i in range(self.n_T, 0, -1):
            progress = (self.n_T - i) / self.n_T * 100  # Progress percentage
            output = format_str.format(i, progress)
            print(output, end="\r")  # Show progress
