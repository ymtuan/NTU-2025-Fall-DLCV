...
SAVE_POSE_PATH="results/private/PAIR_dust3r_predicted_poses.npy"
...
INDEX_TXT_PATH="hw_4_1_data/private_yaw_80.0_to_90.0.txt"



# Root directory containing the ORIGINAL images (e.g., Street/, GreatCourt/)
DATA_ROOT="hw_4_1_data/private/images"




USE_MODEL="Dust3R"  # Change to "Dust3R" to run Dust3R evaluation
MODEL_PATH="/home/kennethyang/ExtremeVideoPose/dust3r/checkpoints/DUSt3R_ViTLarge_BaseDecoder_512_dpt.pth" # <--- UPDATE THIS 
