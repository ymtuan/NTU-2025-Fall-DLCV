...
ids_val = [image_name for image_name in os.listdir(os.path.join(data_path, "validation")) if is_image_file(image_name)]
...
dataset_val = DeepGlobe(os.path.join(data_path, "validation"), ids_val, label=True)
